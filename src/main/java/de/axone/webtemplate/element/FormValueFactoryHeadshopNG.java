...
public class FormValueFactoryHeadshopNG extends AbstractFormValueFactory implements FormValueFactory {

	public FormValueFactoryHeadshopNG(){
	...
	public FormValue<Date> createInputDateValue(
		...
		return createInputDateValue( DATE_INPUT_TYPE(),
